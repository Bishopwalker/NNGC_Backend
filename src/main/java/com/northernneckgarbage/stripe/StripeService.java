package com.northernneckgarbage.stripe;

import com.northernneckgarbage.controller.SseController;
import com.northernneckgarbage.dbConfig.StripeApiResponse;
import com.northernneckgarbage.dbConfig.StripeCustomApiResponse;
import com.northernneckgarbage.dbConfig.StripeRegistrationResponse;
import com.northernneckgarbage.entity.StripeTransactions;
import com.northernneckgarbage.repository.CustomerRepository;
import com.northernneckgarbage.repository.StripeTransactionRepository;
import com.northernneckgarbage.roles.AppUserRoles;
import com.northernneckgarbage.stripe.transaction.Address;
import com.northernneckgarbage.stripe.transaction.Card;
import com.northernneckgarbage.stripe.transaction.*;
...
//
    ...
    log.info("Customer: " + customerInvoice);
                if (customerInvoice.isEmpty()) {
                    com.northernneckgarbage.entity.Customer customer1 = new com.northernneckgarbage.entity.Customer();
...
public StripeApiResponse<Customer> createStripeCustomer(Long id) throws StripeException {
    ...
    public void createStripeCustomersForAllUsers() {
        // Get all users
        List<com.northernneckgarbage.entity.Customer> users = customerRepository.findAll();

        // Loop through each user
        for (com.northernneckgarbage.entity.Customer user : users) {
...
//                                        .build())
    ...
    public StripeCustomApiResponse getAllTransactionsFromStripeByCustomerId(Long id) throws StripeException {
        ...
        com.northernneckgarbage.entity.Customer finalUser = user;
